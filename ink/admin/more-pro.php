<style>
			...
			#tabs_b_more_pro .hndle , #tabs_b_more_pro .handlediv{
			display:none;
			}
			#tabs_b_more_pro p{
			color:#000;
				...
				<div class="col-md-12">
					...
					<div class="col-md-4"> 
							...
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpsm_tabs_b_directory_url.'assets/images/tabs-pro-screesnhot.png'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="tabs pro plugin">
					...
					<div class="col-md-4"> 
							...
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpsm_tabs_b_directory_url.'assets/images/csp.png'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
					...
					<div class="col-md-4"> 
							...
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpsm_tabs_b_directory_url.'assets/images/ac.png'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
					...
					<div class="col-md-4"> 
							...
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpsm_tabs_b_directory_url.'assets/images/counters.jpg'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
					...
					<div class="col-md-4"> 
							...
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpsm_tabs_b_directory_url.'assets/images/service-showcase-pro-preview.jpg'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
					...
					<div class="col-md-4"> 
							...
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpsm_tabs_b_directory_url.'assets/images/cb.png'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
